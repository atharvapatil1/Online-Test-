...
public class OnlineTest extends JFrame implements ActionListener
{
	...
	frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		frame.setTitle("Online Test Application");
	...
	OnlineTest()
	{
		...
		l2=new JLabel();
		l2.setText("Mini Project");
		l2.setBounds(230,11,300,25);
	...
	{
		JFrame f =new JFrame();
		f.setTitle("GROUP MEMBERS");
		f.setVisible(true);
		f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		f.setBounds(100,50,500,500);
		f.setLayout(null);
		Component c2=f.getContentPane();
	}
	...
	void set()
	{
		...
		if(current==4)
		{
			l.setText("Que5: Which of these keywords are used to define an abstract class?");
			jb[0].setText("abst");jb[1].setText("Abstract");jb[2].setText("abstract");jb[3].setText("abstract class");
		}
		if(current==5)
		{
